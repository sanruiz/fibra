...
/**
 * 
 * Partial Name: FibrasomaHomeEvents
 * 
 */
if ( ! defined( 'ABSPATH' ) ) {
...
function printEvent ($id) {
    ...
    $formated_init_date = $content['end_date'] ? translateDate(date("M j, Y", $content['init_date']), 'short') : translateDate(date("M j, Y", $content['init_date']));
    $formated_end_date = $content['end_date'] ? translateDate(date("M j, Y", $content['end_date']), 'short') : null;
