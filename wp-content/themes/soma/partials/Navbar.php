...
<section class="navbar-partial-df27ae style-<?= $header_options['style'] ?>">
                ...
                <div class="top-bar fibrasoma-top-bar">
                    <?php if($header_options['top_bar_link']): ?>
                        <div class="top-bar-link">
                            <a href="<?= $header_options['top_bar_link']['url'] ?>" target="<?= $header_options['top_bar_link']['target'] ?>">
                                ...
                                <?= $header_options['top_bar_link']['title'] ?>
                            </a>
                        </div>
                    <?php endif; ?>
