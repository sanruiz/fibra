...
<section class="annualreports-partial-5d3457 <?= get_query_var('soma_block_content')['style'] ?>" 
    data-last-year="<?= get_query_var('soma_block_content')['latest_year_preselect'] ? '1' : '0' ?>" 
