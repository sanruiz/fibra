            ...
            <div class="view-mode">
                <div class="list current-view">
                  <svg width="20px" height="21px" viewBox="0 0 20 21" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span><?= (wpm_get_language() == 'en') ? 'List View' : 'Vista Lista' ?></span>
                </div>
                <div class="grid">
                    ...
                    <span><?= (wpm_get_language() == 'en') ? 'Grid View' : 'Vista Cuadrícula' ?></span>
                </div>
            </div>
        </div>
        <div class="filters movil">
            <div class="ViewAll"> <div style="width: 100%;"><?= (wpm_get_language() == 'en') ? 'View All' : 'Ver Todos' ?> </div> 
