...
<section class="searchpanel-partial-1749fc" data-lang="<?= wpm_get_language() ?>">
    <div class="container">
        <div class="title"><?= $header_options['search_title'] ?></div>
        <div class="search-form">
            <form>
                <input id="theFieldID" type="text" autofocus="autofocus" placeholder="<?= (wpm_get_language() == 'en') ? 'Search' : 'Buscar' ?>">
            </form>
